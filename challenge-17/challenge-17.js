( function() {
  ...
  */
  ...
  var newText = text.replace(/Manuel Marques de Sousa/, 'Diego Parente');
  console.log( newText );
  /*
  ...
  */
  ...
  newText = text.replace(/brasileiro/g, 'carioca');
  console.log( newText );
  /*
  ...
  */
  ...
  newText = text.replace(/O Centauro de Luvas/g, function(name1){
