( function() {
  ...
  */
  console.log( '\nMeus amigos:' );
  var names = [ 'João', 'Gustavo', 'Marcos', 'Benjamin', 'Christiano' ];

  var friends = names.reduce(function(accumulator, currentValue, index){
  ...
  */
  ...
  var myName = 'Diego';
  var newMyName = [];
  for ( var index = 0, len = myName.length; index < len; index++) {
    newMyName.push(
      index % 2 !== 0
      ? myName.charAt(index).toUpperCase()
      : myName.charAt(index).toLowerCase()
    );
  };

  newMyName = newMyName.join('');
